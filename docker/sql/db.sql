...
CREATE TABLE `benutzer` (
  ...
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8_bin NOT NULL,
  `titel` varchar(255) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `vorname` varchar(255) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `nachname` varchar(255) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  ...
  `new_email_token` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8_bin NOT NULL DEFAULT '',
...
CREATE TABLE `vortraege` (
  ...
  `vTitel` varchar(255) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  ...
  `maxTeilnehmeranzahl` varchar(3) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `praefZeit` varchar(255) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `anmerkungen` text CHARACTER SET utf8mb4 NOT NULL,
  `abstract` text CHARACTER SET utf8mb4 NOT NULL,
